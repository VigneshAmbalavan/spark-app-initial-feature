...
from jobs.hf_recipe_preprocess_etl import transform_data


class RecipeETLTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_input_data_path = 'tests/test_data/recipe/input/'
        self.test_exp_data_path = 'tests/test_data/recipe/expected/'
    ...
    def test_transform_data(self):
        ...
        input_data = (
            self.spark
            .read
            .json(self.test_input_data_path))

        expected_data = (
            self.spark
            .read
            .parquet(self.test_exp_data_path))
